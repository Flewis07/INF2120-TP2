...
public class NouveauFichier {
     ...
     * @param listeSyllables Arraylist contenant les Arraylist qui contient les Strings unicode Japonais a mettre dans le nouveau
     *          fichier.
     * @return un nouveau fichier HTML de type FileWriter.
     * @throws IOException
     */
    public static FileWriter newFile(String nomFichier, ArrayList<ArrayList<String>> listeSyllables) throws IOException {
     ...
     */
    public static String blocLignes(ArrayList<ArrayList<String>> listeSyllables) {
        String bloc = "";
        int j = 0;
        int longueurLigne = 0;
